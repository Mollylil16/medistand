          ...
          <div className="max-w-4xl mx-auto text-center space-y-4 sm:space-y-6 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 md:gap-8 justify-center pt-4 sm:pt-6">
              <div className="text-center">
                <div className="text-3xl sm:text-4xl font-bold text-accent mb-1 sm:mb-2">50+</div>
                <div className="text-sm sm:text-base text-gray-300">Événements réalisés</div>
              </div>
              <div className="text-center">
                <div className="text-3xl sm:text-4xl font-bold text-accent mb-1 sm:mb-2">100+</div>
                <div className="text-sm sm:text-base text-gray-300">Stands installés</div>
              </div>
              <div className="text-center">
                <div className="text-3xl sm:text-4xl font-bold text-accent mb-1 sm:mb-2">30+</div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-7xl mx-auto">
            {realisations.map((realisation, index) => (
              ...
              >
                {/* Image Placeholder */}
                <div className="relative h-[180px] sm:h-[200px] md:h-[220px] lg:h-48 bg-gradient-to-br from-primary/10 to-secondary/10">
                ...
                <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
                  <div>
                    <h3 className="text-lg sm:text-xl font-bold text-primary mb-1 sm:mb-2 line-clamp-2">
                      {realisation.titre}
                    </h3>
                    <div className="text-base sm:text-lg text-accent font-semibold">
                  ...
                  <div className="space-y-2 text-xs sm:text-sm">
                    ...
                    <div className="flex items-center space-x-2 text-gray-600">
                      ...
                      <span className="break-words">{realisation.lieu}</span>
                    </div>
                  </div>
                </div>
              </Card>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
            {temoignages.map((temoignage, index) => (
              <Card 
                key={temoignage.id}
                className="p-4 sm:p-6 md:p-8 animate-fade-in-up"
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 max-w-7xl mx-auto">
            {[...Array(8)].map((_, index) => (
              <div
                key={index}
                className="aspect-square bg-gradient-to-br from-primary/10 to-secondary/10 rounded-lg sm:rounded-xl flex items-center justify-center hover:scale-105 transition-transform duration-300 cursor-pointer animate-scale-in"
