...
export const CTASection: React.FC = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-primary via-primary-700 to-primary-900 text-white relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl text-gray-200 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            Contactez-nous dès aujourd'hui pour obtenir un devis personnalisé et discuter de votre prochain événement.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up pt-4" style={{ animationDelay: '200ms' }}>
            <Link href="/tarifs">
            ...
            <a href={`tel:${contactInfo.telephone}`}>
              <Button size="lg" className="bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white hover:bg-white hover:text-primary">
          ...
          <div className="pt-8 flex flex-col md:flex-row gap-8 justify-center items-center text-sm">
